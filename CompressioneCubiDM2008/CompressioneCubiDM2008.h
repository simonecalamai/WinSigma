// CompressioneCubiDM2008.h : main header file for the COMPRESSIONECUBIDM2008 DLL
//
...
// See CompressioneCubiDM2008.cpp for the implementation of this class
//


class CCompressioneCubiDM2008App : public CWinApp
{
public:
	CCompressioneCubiDM2008App();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CCompressioneCubiDM2008App)
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CCompressioneCubiDM2008App)
