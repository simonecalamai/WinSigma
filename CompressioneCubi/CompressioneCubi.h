// CompressioneCubi.h : main header file for the COMPRESSIONECUBI DLL
//
...
// See CompressioneCubi.cpp for the implementation of this class
//


class CCompressioneCubiApp : public CWinApp
{
public:
	CCompressioneCubiApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CCompressioneCubiApp)
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CCompressioneCubiApp)
