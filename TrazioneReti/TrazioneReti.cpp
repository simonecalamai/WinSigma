// TrazioneReti.cpp : Defines the initialization routines for the DLL.
//

#include "stdafx.h"
#include "TrazioneReti.h"
#include "MainDlg.h"
...
BEGIN_MESSAGE_MAP(CTrazioneRetiApp, CWinApp)
	//{{AFX_MSG_MAP(CTrazioneRetiApp)
...
/////////////////////////////////////////////////////////////////////////////
// CTrazioneRetiApp construction

CTrazioneRetiApp::CTrazioneRetiApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CTrazioneRetiApp object

CTrazioneRetiApp theApp;
...
//-----------------------------		
			...
			if(pSerieProviniSet->m_TipoProva==1 || pSerieProviniSet->m_TipoProva==3)
				...
				allungamentoPerc	= pDati->allungamento/(fiNominale * 10 ) * 100;
