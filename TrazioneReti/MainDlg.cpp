	...
	if(m_pDatiCorrenti->lunghezza!=0)
		{
			...
			//--- Gestone del numero di cifre per la sezione ---//
			...
			double snervamentoRelativo			= m_pDatiCorrenti->snervamento/sezRilevata * 1000;			
			// tensione relativa percentuale
			double tensioneRelativa					= m_pDatiCorrenti->rottura/sezRilevata * 1000;
