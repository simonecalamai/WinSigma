// TrazionePiegamentoBarre.h : main header file for the TRAZIONEPIEGAMENTOBARRE DLL
//
...
/////////////////////////////////////////////////////////////////////////////
// CTrazionePiegamentoBarreCTApp
// See TrazionePiegamentoBarreCT.cpp for the implementation of this class
//

class CTrazionePiegamentoBarreCTApp : public CWinApp
{
public:
	CTrazionePiegamentoBarreCTApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CTrazionePiegamentoBarreCTApp)
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CTrazionePiegamentoBarreCTApp)
