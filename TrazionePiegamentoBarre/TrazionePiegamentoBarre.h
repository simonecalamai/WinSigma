...
// See TrazionePiegamentoBarre.cpp for the implementation of this class
//

class CTrazionePiegamentoBarreApp : public CWinApp
{
public:
	CTrazionePiegamentoBarreApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CTrazionePiegamentoBarreApp)
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CTrazionePiegamentoBarreApp)
