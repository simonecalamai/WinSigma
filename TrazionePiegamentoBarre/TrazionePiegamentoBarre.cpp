// TrazionePiegamentoBarre.cpp : Defines the initialization routines for the DLL.
//

#include "stdafx.h"
#include "afx.h"
#include "TrazionePiegamentoBarre.h"
#include "MainDlg.h"
...
/////////////////////////////////////////////////////////////////////////////
// CTrazionePiegamentoBarreApp

BEGIN_MESSAGE_MAP(CTrazionePiegamentoBarreApp, CWinApp)
	//{{AFX_MSG_MAP(CTrazionePiegamentoBarreApp)
...
/////////////////////////////////////////////////////////////////////////////
// CTrazionePiegamentoBarreApp construction

CTrazionePiegamentoBarreApp::CTrazionePiegamentoBarreApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CTrazionePiegamentoBarreApp object

CTrazionePiegamentoBarreApp theApp;
...
//---------------
	if(pCertVerbSet->m_TipoCertificato == 13)
	{
		...
		str.Format("Campioni  Sigla: %s", csSiglaFornitore);
		for(; !pSerieProvSet->IsEOF(); pSerieProvSet->MoveNext())
		{
			...
			else
			{
				...
				CString app;
				app.Format("\r\nCampioni  Sigla: %s", csSiglaFornitore);
...
//-----------------------------	
			...
			if(m_nVariante == 0)
				pFieldNames->Add("fyfyk");
			else if (m_nVariante == 1)
...
//        if(!pSerieProviniSet->m_Checked)
        {
            ...
            if(!pSerieProviniSet->m_Checked)
				...
				{
					snervamento				= pDati->snervamento/sezEffettiva * 1000;						
					rotturaRelativa		= pDati->rottura/sezEffettiva * 1000;
				}

				allungamentoPerc = 0;
				if(m_nVariante == 0)
					allungamentoPerc	= pDati->allungamento/(fiNominale * 5 ) * 100;
				else if(m_nVariante == 1)
